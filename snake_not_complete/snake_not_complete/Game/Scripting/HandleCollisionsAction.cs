...
namespace Unit05.Game.Scripting
{
    ...
    public class HandleCollisionsAction : Action
    {
        ...
        private bool PlayerOneWon = false;
        ...
        private void HandleSegmentCollisions(Cast cast)
        {
            ...
            // Handles collisiosn for the the two snakes
            // handles collision for snake 1 segments with head 2
            foreach (Actor segment in body)
            {
            ...
            // handles collision for body 2 segments with head 1
            foreach (Actor segment2 in body2)
            {
